    ...
    <body>
        ...
        <div class="container" id="body_index" >
            ...
            <div id="partie_connexion" >
                ...
                C'est gratuit, sans engagement, et tu as accès à tous les services proposés par TravelCars : location de véhicules,
                parkings à prix réduits...<br/>
                Profite de tous les services qui te sont mis à disposition !</p>
                
                <center><a href="connection.php" class="btn btn-secondary btn-lg active" role="button" >Je me connecte</a></center>
            ...
            <div id="partie_inscription">
                ...
                Rejoindre la communauté TravelCars, c'est profiter de tous les services associés. Un partenariat avec plus d'une
                dizaine d'aéroports te permettra de choisir la meilleure solution de location ou de réservation !</p>
                
                <center><a href="inscription.php" class="btn btn-secondary btn-lg active" role="button" >Je m'inscris</a></center>
