...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <center><a href=#partie_reservation class="btn btn-secondary btn-lg active" role="button" >Réserver une place de parking</a></center>
            ...
            <center><a href=#partie_location class="btn btn-secondary btn-lg active" role="button" >Louer un véhicule</a></center>
            ...
            <p>TravelCars est un site qui permet aux propriétaires et aux locataires de véhicules d'accéder à plusieurs offres
            dans de nombreux aéroports participants. Avec ce service, tu peux économiser de l'argent sur ta réservation de parkings
            pour la durée de ton séjour, pendant qu'une autre personne pourra te la louer, à un tarif plus que raisonnable.<br/>
            C'est ça, l'objectif de TravelCars : pouvoir voyager en toute sérennité, sans avoir à se soucier des soucis que peut 
